/**
 * Source code:   https://www.pegaxchange.com/2018/01/28/websocket-server-java/
 * 
 * Server
 * Execute this server in tomcat. 
 * 
 * Client
 * copy paste the contents of WebSocketClient.js in console of Browser
 * then execute below steps
 * var client = new WebSocketClient('ws', '127.0.0.1', 8080, '/WebSocketServer/endpoint?push=TIME');
 * client.connect();
 */
